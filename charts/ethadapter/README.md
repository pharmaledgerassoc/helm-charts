...
![Version: 0.7.18](https://img.shields.io/badge/Version-0.7.18-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 3.0.0-rc3](https://img.shields.io/badge/AppVersion-3.0.0-rc3-informational?style=flat-square)
...
| image.tag | string | `"3.0.0-rc3"` | Overrides the image tag whose default is the chart appVersion. |
