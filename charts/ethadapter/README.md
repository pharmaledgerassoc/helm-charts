...
| image.sha | string | `"5ed4cc6afce9dae81046be82c73ab3b262bc83f14a1078f675e3b8f4cb2b131b"` | sha256 digest of the image. Do not add the prefix "@sha256:" Default to image digest for version 1.0.2 <!-- # pragma: allowlist secret --> |
| image.tag | string | `"1.0.7"` | Overrides the image tag whose default is the chart appVersion. |
