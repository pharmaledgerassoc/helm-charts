...
![Version: 0.6.5](https://img.shields.io/badge/Version-0.6.5-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: csc.1.1.0](https://img.shields.io/badge/AppVersion-csc.1.1.0-informational?style=flat-square)
...
2. Install via helm to namespace `default`
    ...
    ```bash
    helm upgrade my-release-name pharmaledgerassoc/csc --version=0.6.5 \
        --install \
...
| config.subDomain | string | `"csc.my-company"` | The Subdomain, should be domain.company, e.g. csc.did.rms |
