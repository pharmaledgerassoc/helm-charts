...
![Version: 0.2.5](https://img.shields.io/badge/Version-0.2.5-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.10.4](https://img.shields.io/badge/AppVersion-v0.10.4-informational?style=flat-square)
...
2. Install via helm to namespace `default`
    ...
    ```bash
    helm upgrade my-release-name pharmaledgerassoc/fgt --version=0.2.5 \
        --install \
...
| image.repository | string | `"joaoluispdm/pharmaledgerassoc-fgt"` | The repository of the container image |
