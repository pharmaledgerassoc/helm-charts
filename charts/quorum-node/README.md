...
```shell
helm upgrade --install quorum-node-0 pharmaledgerassoc/quorum-node --version=0.6.4 \
...
1. Install to other namespace
    ...
    ```bash
    helm upgrade my-release-name pharmaledgerassoc/quorum-node --version=0.6.4 \
      --install \
