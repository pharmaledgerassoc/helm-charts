...
![Version: 0.7.1](https://img.shields.io/badge/Version-0.7.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 23.4.0-securityFix9](https://img.shields.io/badge/AppVersion-23.4.0--securityFix9-informational?style=flat-square)
...
```shell
helm upgrade --install quorum-node-0 pharmaledgerassoc/quorum-node --version=0.7.1 \
...
1. Install to other namespace
    ...
    ```bash
    helm upgrade my-release-name pharmaledgerassoc/quorum-node --version=0.7.1 \
      --install \
...
| image.repository | string | `"public.ecr.aws/s6w3n1u5/quorum"` | The repository of the Quorum container image |
| image.sha | string | `"1725008713cdd8167ee911141d4adcd8e60fb684f988053ed60bd4e90ee62acd"` | sha256 digest of the image. Do not add the prefix "@sha256:". <!-- # pragma: allowlist secret --> |
