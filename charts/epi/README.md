...
![Version: 0.6.4](https://img.shields.io/badge/Version-0.6.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2023.1.0](https://img.shields.io/badge/AppVersion-2023.1.0-informational?style=flat-square)
...
2. Install via helm to namespace `default`
    ...
    ```bash
    helm upgrade my-release-name pharmaledgerassoc/epi --version=0.6.4 \
        --install \
...
| builder.image.sha | string | `"11919f8a7bda6ebff40be3148012354b2fb56b0e374610817fa7d144bfec90ec"` | sha256 digest of the image for the builder. Do not add the prefix "@sha256:" Default to v1.3.1 <!-- # pragma: allowlist secret --> |
...
| runner.image.sha | string | `"8134097371f0b8495c328f99def470c1d5dfb3f89e8ba72926f1b82681788482"` | sha256 digest of the image. Do not add the prefix "@sha256:" Default to v1.3.1 <!-- # pragma: allowlist secret --> |
