...
![Version: 0.7.11-rc3](https://img.shields.io/badge/Version-0.7.11--rc3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.0.0-rc2](https://img.shields.io/badge/AppVersion-4.0.0--rc2-informational?style=flat-square)
...
2. Install via helm to namespace `default`
    ...
    ```bash
    helm upgrade my-release-name pharmaledgerassoc/epi --version=0.7.11-rc3 \
        --install \
